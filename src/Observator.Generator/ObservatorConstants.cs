...
namespace Observator.Generator
{
    public static class ObservatorConstants
    {
        ...
        public const string ObservatorInterfaceTraceAttributeFullName = "Observator.Abstractions.ObservatorInterfaceTraceAttribute";
        public const string ObservatorInterfaceTraceAttributeName = "ObservatorInterfaceTraceAttribute";
        public const string ObservatorInterfaceTraceAttributeShortName = "ObservatorInterfaceTrace";
